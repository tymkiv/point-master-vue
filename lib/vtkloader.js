  ...
  parse: function( data ) {
    ...
    function parseASCII( data ) {
      ...
      if ( stagger === 'point' ) {
        ...
        // // console.dir(vertices.__proto__);
        // for ( var j = 0; j < numPoints; ++ j ) {
        //   vertices[3 * j + 0] = positions[ 3 * j + 0 ];
        //   vertices[3 * j + 1] = positions[ 3 * j + 1 ];
        //   vertices[3 * j + 2] = positions[ 3 * j + 2 ];
        //   // vertices.push(positions[ 3 * j + 0 ]);
        //   // vertices.push(positions[ 3 * j + 1 ]);
        //   // vertices.push(positions[ 3 * j + 2 ]);
        //   // x = positions[ 3 * j + 0 ];
        //   // y = positions[ 3 * j + 1 ];
        //   // z = positions[ 3 * j + 2 ];

        //   // geometry.vertices.push( new THREE.Vector3( x, y, z ) );
        //   // geometry.setAttribute( 'position', new THREE.Vector3( x, y, z ) );
